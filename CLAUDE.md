...
Week 4, P4.1-P4.5 done. The seat-contention core is built and proven. The gateway routes, rate-limits and authenticates traffic. booking-service publishes booking.confirmed through a transactional outbox and notification-service consumes it, idempotently, into an email. The frontend is not built.
...
- Tests: 143 across gateway (54), auth (13), event (27), booking (36) and notification (13), on real MySQL, Redis and Kafka via Testcontainers where it matters
